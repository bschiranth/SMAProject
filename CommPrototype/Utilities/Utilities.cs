...
/* Public Interface - 
* -------------------------
* swapURL() - swaps from and to url 
* waitForUser()-sleeps thread till users input
* showMessage()-shows message content and url
...
namespace Project4Starter
{
  static public class Utilities
  {
    ...
    public static string urlPort(string url)
    {
      ...
      return port;                      //returns the port address ex:8080 from the url string
    }
